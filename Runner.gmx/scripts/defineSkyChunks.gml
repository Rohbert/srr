...
currentChunk=0;
currentChunk[0,0] = 1;
//Chunk Objects  Cross formation
currentObjectIndex=0;
//addChunkObject(0,1,1,39,3); //ceiling
//addChunkObject(0,0,(bottomTile-3),40,3); //floor
...
ds_list_add(sky_chunkList,currentChunk);
...
//addChunkObject(0,1,1,39,3); //ceiling
//addChunkObject(0,0,(bottomTile-3),40,3); //floor
addChunkObject(0,10,-1,4,19); //top column
addChunkObject(0,10,(bottomTile-17),4,19); //bottom column
